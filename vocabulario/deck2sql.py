...
def собрать(ключ):
    ...
    for i, c in enumerate(колода["cards"]):
        ...
        строки.append((
            ...
            c.get("en") or "", c.get("exen") or "", c.get("noteen") or "",
        ))
...
def печатать(ключ, кусок=200):
    ...
    out.write(
        ...
        "       count(*) filter (where en <> '') as по_английски\n"
